...
export const ui: Translation = {
  en: {
    ...
    "what.desc": "Hi 👋, I'm an accomplished explorer, a full stack web developer with a passion for Salesforce and Payload CMS.",
    "bio.title": " Short bio",
  ...
  cs: {
    ...
    "what.title": " Co dělám",
    "what.desc": "Ahoj 👋, jsem zkušený průzkumník, full-stack webový vývojář s vášní pro Salesforce a Payload CMS.",
